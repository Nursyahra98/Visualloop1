...
public class KomputerGrafik extends Application implements Runnable {
    //loop parameter
    ...
    @Override
      ...
      private void update (){   
          ...
          else if(inputKeyboard.contains("L")){
              sudutrotasi-=2;
          }
      }
      //loop
      ...
      private void draw () {
        try {
            if (canvas != null){
             ...
             gc.fillRect (-sisi/2.0f, -sisi/2.0f, 50, 150);
             gc.restore();
